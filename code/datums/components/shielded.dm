 ...
 */
/datum/component/shielded/proc/on_hit_react(datum/source, mob/living/carbon/human/owner, atom/movable/hitby, attack_text/*, final_block_chance*/, damage, attack_type) // [CELADON-EDIT] - CELADON_MODSUITS
	SIGNAL_HANDLER
