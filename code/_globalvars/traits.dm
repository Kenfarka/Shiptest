...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_NOFIRESPREAD" = TRAIT_NOFIRE,
		...
		"TRAIT_VERY_HARDLY_WOUNDED" = TRAIT_VERY_HARDLY_WOUNDED,
		...
		"TRAIT_SENSITIVE_TONGUE" = TRAIT_SENSITIVE_TONGUE,
		...
		"TRAIT_NOBREAK" = TRAIT_NOBREAK,
		"TRAIT_ALLBREAK" = TRAIT_ALLBREAK,
